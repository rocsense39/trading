...
- XEON target: 5%, used as temporary parking/reserve.
- IUHC target: 2%, legacy diversification holding; no new purchases.
- Proposed order size: EUR 25-100.
- Review weekly; contributions do not have to be weekly.
