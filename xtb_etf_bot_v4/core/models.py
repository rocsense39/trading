...
class AllocationRow:
    ...
    def gap_pct(self) -> float:
        """Allocation gap in percentage points of account equity.

        Positive means the ETF is underweight; negative means overweight.
        Example: target 45%, actual 22.6% => gap_pct 0.224.
        """
